<?php
    ...
    class Page 
    {
        ...
        private function first()
        {
            $str = '';
            if ( $this->page != 1 ) {
                $str .= '<a href="'.$this->url.'1">'.$this->config['first'].'</a>';
            }
            return $str;
        }
        ...
        private function last()
        {
            ...
            if ( $this->page != $this->pageNum ) {
                $str .= '<a href="'.$this->url.$this->pageNum.'">'.$this->config['last'].'</a>';
            }
            return $str;
        }
        ...
        private function prev()
        {
            $str = '';
            if ( $this->page != 1 ) {
                $str = '<a href="'.$this->url.($this->page - 1).'">'.$this->config['prev'].'</a>';
            }
            return $str;
        }
        ...
        private function next()
        {
            $str = '';
            if ( $this->page != $this->pageNum ) {
                $str = '<a href="'.$this->url.($this->page + 1).'">'.$this->config['next'].'</a>';
            }
            return $str;
        }
        ...
        private function number()
        {
            ...
            for ($i=$num; $i>=1; $i--) {
                ...
                $str .= '<a href="'.$this->url.$page.'">'.$page.'</a>';
            }
            $str .= $this->page;
            for ($i=1; $i<=$num; $i++) {
                $page = $this->page+$i;
