...
exo;
           ...
           self::makeDir(APP_NAME.'/view/public');//公共模板
           if ( !file_exists(APP_NAME.'/view/public/error.html') ) {
              copy(APP_ROOT.'/PHP4Y/lib/smarty/redirect/error.html', APP_NAME.'/view/public/error.html');
           } 
           if ( !file_exists(APP_NAME.'/view/public/success.html') ) {
              copy(APP_ROOT.'/PHP4Y/lib/smarty/redirect/success.html', APP_NAME.'/view/public/success.html');
           }  
