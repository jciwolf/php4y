    ...
    class Action extends Smarty
    {
         ...
         public function __construct()
         {
            ...
            @$this->right_delimiter = SMARTY_R_DELIMITER;   //模板文件中使用的“右”分隔符号
             ...
             $this->assign("js" , APP_ROOT.'/public/'.APP_NAME.'/js');
             $this->assign("images" , APP_ROOT.'/public/'.APP_NAME.'/images');
             $this->assign("css" , APP_ROOT.'/public/'.APP_NAME.'/css');
             $this->assign("upload" , APP_ROOT.'/public/upload');
             $this->assign("public" , APP_ROOT.'/public');
         }
         //重载display方法
